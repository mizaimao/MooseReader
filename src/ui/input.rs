...
use crate::config::{save_config, Alignment, Config, ProgressMode, Theme};
use crate::epub::load_chapter;
use super::{AppMode, AppState};

pub fn handle_reading_input(code: KeyCode, app: &mut AppState, cfg: &mut Config, lines: &mut Vec<String>, archive: &mut ZipArchive<File>, spine: &[(String, String)]) -> bool {
    match code {
...
pub fn handle_toc_input(code: KeyCode, app: &mut AppState, cfg: &Config, lines: &mut Vec<String>, archive: &mut ZipArchive<File>, spine: &[(String, String)]) -> bool {
    match code {
...
pub fn handle_settings_input(code: KeyCode, app: &mut AppState, cfg: &mut Config, lines: &mut Vec<String>, archive: &mut ZipArchive<File>, spine: &[(String, String)]) -> bool {
    match code {
        ...
        KeyCode::Char('k') | KeyCode::Up => app.settings_cursor = if app.settings_cursor == 0 { 13 } else { app.settings_cursor - 1 },
        ...
        KeyCode::Char('h') | KeyCode::Left => {
            ...
            match app.settings_cursor {
                ...
                4 => cfg.theme = match cfg.theme { 
                    Theme::Default => Theme::Oceanic, Theme::Sepia => Theme::Default, Theme::Dracula => Theme::Sepia, 
                    Theme::Hacker => Theme::Dracula, Theme::Nord => Theme::Hacker, Theme::SolarizedLight => Theme::Nord, 
                    Theme::SolarizedDark => Theme::SolarizedLight, Theme::Gruvbox => Theme::SolarizedDark,
                    Theme::Monokai => Theme::Gruvbox, Theme::Catppuccin => Theme::Monokai, Theme::Oceanic => Theme::Catppuccin 
                },
                5 => cfg.show_footer = !cfg.show_footer,
                6 => cfg.dim_footer = !cfg.dim_footer,
                7 => cfg.footer_align = match cfg.footer_align { Alignment::Left => Alignment::Right, Alignment::Center => Alignment::Left, Alignment::Right => Alignment::Center },
                ...
                11 => if cfg.progress_bar_length > 5 { cfg.progress_bar_length -= 1; }, 
        ...
        KeyCode::Char('l') | KeyCode::Right => {
            ...
            match app.settings_cursor {
                ...
                4 => cfg.theme = match cfg.theme { 
                    Theme::Default => Theme::Sepia, Theme::Sepia => Theme::Dracula, Theme::Dracula => Theme::Hacker, 
                    Theme::Hacker => Theme::Nord, Theme::Nord => Theme::SolarizedLight, Theme::SolarizedLight => Theme::SolarizedDark, 
                    Theme::SolarizedDark => Theme::Gruvbox, Theme::Gruvbox => Theme::Monokai, Theme::Monokai => Theme::Catppuccin, 
                    Theme::Catppuccin => Theme::Oceanic, Theme::Oceanic => Theme::Default 
                },
                5 => cfg.show_footer = !cfg.show_footer,
                6 => cfg.dim_footer = !cfg.dim_footer,
                7 => cfg.footer_align = match cfg.footer_align { Alignment::Left => Alignment::Center, Alignment::Center => Alignment::Right, Alignment::Right => Alignment::Left },
                8 => cfg.show_chapter_title = !cfg.show_chapter_title,
                9 => cfg.progress_mode = match cfg.progress_mode { ProgressMode::Chapter => ProgressMode::Overall, ProgressMode::Overall => ProgressMode::Chapter },
                10 => cfg.show_progress_bar = !cfg.show_progress_bar,
                11 => if cfg.progress_bar_length < 100 { cfg.progress_bar_length += 1; }, 
                12 => cfg.show_progress_percentage = !cfg.show_progress_percentage,
                13 => cfg.show_chapter_location = !cfg.show_chapter_location,
                _ => {}
            }
...
pub fn handle_resize(new_cols: u16, new_rows: u16, app: &mut AppState, cfg: &Config, lines: &mut Vec<String>, archive: &mut ZipArchive<File>, spine: &[(String, String)]) {
    let current_progress = if lines.is_empty() { 0.0 } else { app.offset as f64 / lines.len() as f64 };
