...
* **Book Formatting:** Italic, bold, underline, small caps, centered and right-aligned paragraphs and first-line indents, read from the book's own stylesheets as well as its HTML tags. Turn on Plain Styles in Settings to ignore the book's stylesheets.
